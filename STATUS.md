...
and `BUNDLE_MODEL.md` (`item_type = 'simple' | 'bundle'`, JSON
component shape with per-component `qty` / `price_source` /
...
Spec-only — no code, no DB. 10 open questions flagged for owner
review across the two new specs before Phase 4.2b implementation.

Engines stay pure; suite still 402 / 1039 green (no code touched).

Awaiting owner review of the Phase 4.2a open questions, then Phase
4.2b implementation. Other open directions: Phase 5 cart
integration, Phase 4 dalis 3 library items import.
