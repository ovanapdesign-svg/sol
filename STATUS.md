...
4.3 PHPUnit tests green (563 / 1518).
...
badge alongside the technical key. Backend + REST + badges shipped
this chunk; the single-page Woo product ConfigKit-tab UI that
drives all 10 blocks lands in the next follow-up. 23 new PHPUnit
tests; suite 540 / 1429 → 563 / 1518.
...
Awaiting Phase 4.3 follow-up: the single-page Woo product
ConfigKit-tab UI (`assets/admin/js/product-builder.js`) that wires
the orchestrator REST surface into the 10 blocks owners see. After
that, Phase 4.2b.3 cart wiring + bundle reconciliation, broader
cart integration in Phase 5, or owner re-test of dalis 4 + 4.2c +
4.3 on real Sologtak data.
