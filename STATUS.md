...
Awaiting Phase 4.2b.2 (admin UI for the new fields) — bundle
composition editor, item type two-card selector, price source
dropdown, library item Resolved-price preview panel, plus the
Woo product binding's per-item override editor. Other open
directions: Phase 5 cart integration, Phase 4 dalis 3 library
items import.
